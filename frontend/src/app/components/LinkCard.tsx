    ...
    return(<>
            <section className={"gap-8 p-4 flex justify-between items-center bg-white rounded-sm w-[750px]"}>
                <div className={"flex-col justify-between"}>
                    ...
                    <p className={"text-black text-lg"}>{originalLink}</p>
                </div>
                <div className={"flex-col"}>
                        <p className={"text-gray-400 text-sm"}>Your shortened link</p>
                    <div className={"flex flex-row items-center"}>
                        <Link className={"text-blue-600 text-lg pr-1"}
                              href={'http://localhost:3000/' + shortenLink}>{'http://localhost:3000/' + shortenLink}</Link>
                        <button className={"items-center p-1 stroke-gray-400 w-full h-full bg-transparent rounded-md border-none hover:stroke-blue-600 hover:bg-blue-200 hover:bg-opacity-10"} onClick={() => handleCopyToClipboard()}><CopyToClipboard/></button>
                        <button className={"items-center p-0.45 fill-gray-400 w-full h-full bg-transparent rounded-md border-none hover:fill-blue-600 hover:bg-blue-200 hover:bg-opacity-10"} onClick={() => handleQRCodeGeneration()}><GenerateQrCode/></button>
                    </div>
